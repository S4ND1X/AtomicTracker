...
class HabitFragment : Fragment(), View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            ubicacion = it.getString(ARG_UBICACION).toString()
    ...
    fun editHabit(){
        ...
        //currid = location()
        //Toast.makeText(this.context, "$ubicacion", Toast.LENGTH_SHORT).show()
    ...
    override fun onCreateView(
        ...
        mapButton = view.findViewById(R.id.buttonMap)
        mapButton.setOnClickListener { this.openMaps() }
        return view
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(id: String, nombre: String, descripcion: String, inicio: String, fin: String, frecuencia: String, ubicacion: String ) =
            HabitFragment().apply {
    ...
    fun openMaps(){
        ...
        //Toast.makeText(this.context, "Sending the ubication $ubicacion", Toast.LENGTH_SHORT).show()
        startActivity(intent)
    ...
    //LAUNCH VIDEO
    fun openVideo(){
        var url = "https://www.youtube.com/watch?v=BllAH1xM2gs"
