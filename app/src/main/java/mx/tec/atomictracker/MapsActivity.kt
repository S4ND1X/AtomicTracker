...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     setContentView(binding.root)
        ...
        //Toast.makeText(this, "I received the location $ubicacion", Toast.LENGTH_SHORT).show()
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        //Toast.makeText(this, "I should be in the location : $latitud , $longitud ", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onMapClick(latLng: LatLng) {
        ...
        Toast.makeText(this, "$lat, $longitud", Toast.LENGTH_SHORT).show()
        finish()
    }
}